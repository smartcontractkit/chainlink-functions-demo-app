...
module.exports = {
  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        'green-gradient': 'linear-gradient(180deg, rgba(60, 139, 236, 0.2) 0%, rgba(168, 245, 220, 0.2) 100%)',
        'blue-gradient': 'linear-gradient(123.77deg, rgba(197, 100, 237, 0.2) -2.01%, rgba(89, 212, 237, 0.2) 102.02%)',
      },
    },
  },
  variants: {
