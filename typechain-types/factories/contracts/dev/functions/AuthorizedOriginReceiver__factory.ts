...
} from "../../../../contracts/dev/functions/AuthorizedOriginReceiver";
...
export class AuthorizedOriginReceiver__factory {
  static readonly abi = _abi;
  static createInterface(): AuthorizedOriginReceiverInterface {
    return new utils.Interface(_abi) as AuthorizedOriginReceiverInterface;
  }
  static connect(
    address: string,
