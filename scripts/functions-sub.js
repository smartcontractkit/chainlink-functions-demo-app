/**
 * 
 * npx hardhat run scripts/functions-sub.js --network mumbai
Subscription created with ID: 422
Duplicate definition of Transfer (Transfer(address,address,uint256,bytes), Transfer(address,address,uint256))
Funding with 1000000000000000000 Juels (1 LINK = 10^18 Juels)
Subscription 422 funded with 1000000000000000000 Juels (1 LINK = 10^18 Juels)
Adding consumer contract address 0xBDF911Ee073D970019932eE21aa1476639865330 to subscription 422
Authorized consumer contract: 0xBDF911Ee073D970019932eE21aa1476639865330
 */
async function main() {
  ...
  const consumer = '0xBDF911Ee073D970019932eE21aa1476639865330'; // Created Consumer Contract
